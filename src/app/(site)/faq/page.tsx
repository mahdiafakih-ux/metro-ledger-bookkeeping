...
const FAQS = [
  ...
  { q: "What is remote online notarization?", a: "Remote online notarization (RON) allows eligible documents to be notarized entirely online through a secure video session. Not all documents qualify for RON — eligibility depends on the document type and transaction. We'll confirm whether your document is eligible when you book." },
  { q: "Do you offer online notarization?", a: "Yes — remote online notarization is available for eligible documents and transactions. Book an appointment and select 'Remote Online' to check eligibility." },
  ...
  { q: "Do you provide recurring services?", a: "Yes — our Business10 and Business30 plans are built for organizations with regular notary needs, with simple monthly invoicing." },
